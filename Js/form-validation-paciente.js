...
direction: /^.{4,40}$/, // Letras, numeros, guion y guion_bajo
Obrasocial: /^[a-zA-ZÀ-ÿ\s]{1,40}$/, // Letras y espacios, pueden llevar acentos.
}
...
if(campos.nombre && campos.password && campos.correo && campos.telefono && campos.direction && campos.Obrasocial){
    formulario.reset();
